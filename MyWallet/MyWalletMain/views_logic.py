...
class DataSetMAinPage:
    ...
    def __init__(self, tag_name=None, pre_tag_name=None):
    ...
    def data_set(self):
        ...
        data = {'pre_tag': PreTag.objects.all().values(),
                ...
                'data': WalletData.objects.all().values(),
    ...
    def filter_by_increasing_date(self):
        ...
        data = {'pre_tag': PreTag.objects.all().values(),
                'tag': WalletTag.objects.all().values(),
                'data': WalletData.objects.all().values().order_by('-date'),
                'sum': WalletData.objects.all().values('price').aggregate(Sum('price'))
                }
        return data
    ...
    def filter_by_increasing_price(self):
        ...
        data = {'pre_tag': PreTag.objects.all().values(),
                'tag': WalletTag.objects.all().values(),
                'data': WalletData.objects.all().values().order_by('-price'),
                'sum': WalletData.objects.all().values('price').aggregate(Sum('price'))
                }
        return data
    ...
    def filter_by_tag_name(self):
        ...
        if (any([(self.tag_name != ''), (self.tag_name != None)])):
            data = {'pre_tag': PreTag.objects.all().values(),
                    'tag': WalletTag.objects.all().values(),
                    'data': WalletData.objects.filter(wallet_tag_id=self.tag_name).values(),
    ...
    def filter_by_pre_tag(self):
        ...
        if (any([(self.pre_tag_name != ''), (self.pre_tag_name != None)])):
            data = {'pre_tag': PreTag.objects.all().values(),
                    'tag': WalletTag.objects.all().values(),
                    'data': WalletData.objects.filter(wallet_pre_tag_id=self.pre_tag_name).values(),
                    'sum':  WalletData.objects.filter(wallet_pre_tag_id=self.pre_tag_name).values().aggregate(Sum('price'))
                    }
            return data
        else:
            data = {'pre_tag': PreTag.objects.all().values(),
...
class CreateWalletArticles:
    ...
    def __init__(self, price, tag, pre_tag):
        self.price = price
        self.tag = tag
        self.pre_tag = pre_tag
